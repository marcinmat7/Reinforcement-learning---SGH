...
# cwd = os.getcwd()
cwd = 'C:\\Users\\garri\\Desktop\\rakietka_v0.1'
...
#inputpath = 'C:\\Users\\garri\\Desktop\\rakietka_v0.1\\' + parameters + '\\Pokolenie_' + str(pokolenie) + '\\run_' + str(run) + '.csv'
inputpath = 'C:\\Users\\garri\\Desktop\\rakietka\\' + parameters + '\\Pokolenie_' + str(pokolenie) + '\\run_' + str(run) + '.csv'
...
cwd = 'C:\\Users\\garri\\Desktop\\rakietka_v0.1\\figures'
decision = 0
...
while True:
    ...
    if keys[pygame.K_z]:
        ...
        sciezka = 'C:\\Users\\garri\\Desktop\\rakietka_v0.1\\figures\\' + parameters + '\\Pokolenie_' + str(pokolenie) + '\\run_' + str(run) + '_results.csv'
