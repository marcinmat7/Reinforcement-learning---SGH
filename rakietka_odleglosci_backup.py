...
# Rakietka latająca w zależności od parametrów
...
angle = -90
text0 = font.render(str(angle), True, green, gray)
textP30 = font.render(str(angle), True, green, gray)
textP60 = font.render(str(angle), True, green, gray)
...
while True:
    ...
    if stop == False:
        ...
        text0 = font.render(str(tekst0), True, green, gray)
        textP30 = font.render(str(tekstP30), True, green, gray)
        textP60 = font.render(str(tekstP60), True, green, gray)
        textM30 = font.render(str(tekstM30), True, green, gray)
        textM60 = font.render(str(tekstM60), True, green, gray)
        ...
        sangle = 15
        bangle = 30
        a0 = math.tan(math.radians(anglecorrect + sangle))
        b0 = (1050 - czubek[1] - czubek[0] * a0)
        baP30 = crosspointsfunction(anglecorrect +sangle, coord, czubek)

        a0 = math.tan(math.radians(anglecorrect + bangle))
        b0 = (1050 - czubek[1] - czubek[0] * a0)
        baP60 = crosspointsfunction(anglecorrect + bangle, coord, czubek)

        a0 = math.tan(math.radians(anglecorrect - sangle))
        b0= (1050 - czubek[1] - czubek[0] * a0)
        baM30  = crosspointsfunction(anglecorrect - sangle, coord, czubek)

        a0 = math.tan(math.radians(anglecorrect - bangle))
        b0 = (1050 - czubek[1] - czubek[0] * a0)
        baM60 = crosspointsfunction(anglecorrect - bangle, coord, czubek)
