...
inputpath = '/home/marcin/Pulpit/rakietka_v0.1/' + parameters + '/Pokolenie_' + str(pokolenie) + '/run_100.csv'
...
#inputpath = '/home/marcin/Pulpit/rakietka_v0.1/' + parameters + '/Pokolenie_' + str(pokolenie) + '/run_' + 2 + '.csv'
pars = pd.read_csv(inputpath)
